  ...
  return (
    <div className=" grid grid-cols-6 gap-1 mt-20 p-3">
      <div className="  max-h-[60vh] col-span-2 ">
        <NewsCard subject="Progetto Arca" authName="Redazione" date="13 Luglio 2022" title="“Qui Odessa”, fotografie, progetti e solidarietà" sizes="h-[60vh] w-[100vw]" image={odessa}></NewsCard>
      </div>
      <div className="  max-h-[60vh] col-span-2 ">
        <NewsCard  subject="Adolescenti" authName="Luca Cereda" date="13 Luglio 2022" title="Storie fra ragazzi permeate di violenza. A Napoli 12enne sfregiata da 17enne" sizes="h-[60vh] w-[100vw]" image={violence} ></NewsCard>
      </div>
      <div className=" max-h-[60vh] col-span-2 ">
        <NewsCard  subject="Economia Civile" authName="Emiliano Moccia" date="12 Luglio 2022" title="“Co-agitiamo”, Tiggiano una cooperativa di comunità contro lo spopolamento" sizes="h-[60vh] w-[100vw]" image={meeting} ></NewsCard>
      </div>
      <div className=" max-h-[50vh] col-span-2">
        <NewsCard  subject="Sport" authName="Diletta Grella" date="7 Luglio 2022" title="Troppi abusi nello sport minorile, il governo interviene" sizes="h-[50vh] w-[100vw]" image={abuse} ></NewsCard>
      </div>
      <div className="  max-h-[50vh] col-span-4">
        <NewsCard  subject="Società" authName="Anna Spena" date="7 Luglio 2022" title="Donne e nuove generazioni: con loro riparte l’Italia" sizes="h-[50vh] w-[100vw]" image={woman}  ></NewsCard>
      </div>
