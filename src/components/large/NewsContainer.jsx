  ...
  return (
    <div className=" grid grid-cols-2 gap-1 mt-20 p-3">
      ...
      <div className=" max-h-[68vh] col-span-1 ">
        <NewsCard position="bottom-1 left-2 p-5 max-h-[100vh]" subject="Allarmi" authName="Ugo Lombi" date="14 Luglio 2022" title="Il collasso dei ghiacciai negli scatti del fotografo ambientale Fabiano Ventura" sizes="h-[119vh] w-[100vw]" image={ice}></NewsCard>
      </div>
      <div className="  max-h-[68vh] col-span-1 ">
        <NewsCard position="bottom-1 left-2 p-5 max-h-[68vh]" subject="Esperimenti" authName="Diletta Grella" date="14 Luglio 2022" title="Gli startupper? Li trovi al bistrot. Così il DumBo incuba relazioni" sizes="h-[68vh] w-[100vw]" image={startup}></NewsCard>
      </div>
      <div className=" max-h-[50vh] col-start-2">
        <NewsCard position="bottom-1 left-2 p-5 max-h-[50vh]" subject="Ucraina" authName="Anna Spena" date="14 Luglio 2022" title="Nelle città italiane tutti in piazza per e con Kiev" sizes="h-[50vh] w-[100vw]" image={ukraine}></NewsCard>
      </div>
    </div>
  );
};
